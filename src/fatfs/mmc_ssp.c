...
#define	MMC_CD		(!LPC_GPIO0_Bits->PIO7)	/* Card detect (yes:true, no:false, default:true) */
#define	MMC_WP		0						/* Write protected (yes:true, no:false, default:false) */
#define	CS_LOW()		LPC_GPIO0_Bits->PIO11 = 0	/* Set P0.6 low */
#define	CS_HIGH()	LPC_GPIO0_Bits->PIO11 = 1	/* Set P0.6 high */
